---
source: RDMD/information1.md (부분)
legacy_id: information1
area: frontend
feature: tier-class
---

# 공식 티어표(tier-class) — 프론트 기록 안내

초기 티어 페이지 레이아웃·CSS 정리는 **공통 리팩터 기록**에 포함되어 있습니다.
...
| 04 | [03-kita-kintaro-2tier-record.md](./03-kita-kintaro-2tier-record.md) | 2티어 키타 킨타로 추가 |

## 코드 위치

- `tier-class/tier1.html` ~ `tier9.html`
- `tier-image/`

기능 설명: [../../features/tier-class.md](../../features/tier-class.md)