...
- 9개 티어 단계 지원 (1등급 ~ 9등급)
- 좌측 캐릭터 풀 ↔ 우측 티어 보드
- **꾸미기**: 테두리 색·배경 이펙트, 등급마다 다른 테마, 원래 상태로 돌려놓기 (PNG/PDF·게시글에 함께 저장)
- **초기화**, **다운로드** 기능
...
- 제작한 티어표 **업로드** (가운데 모달: 제목·내용·썸네일)
- 제목, 내용, 썸네일(직접 사진 또는 첫 캐릭터)
- 다른 유저의 티어표 **구경 + 댓글**
- 좋아요, 신고 기능
...
- 댓글 + 대댓글 작성
- 작성자 게시글 필터 (`@작성자` 검색)
- 본인 글 **수정하기** (공유하기·신고하기 사이) → `post_edit.html` → **수정완료** 후 상세로 복귀
