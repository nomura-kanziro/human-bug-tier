...
- 유저 프로필 드롭다운(일반 유저+어드민 공용, 메뉴만 다름): `common.js` `renderUserProfile()` 이하 `toggleUserProfileMenu`/`closeUserProfileMenu*`/`buildAdminProfilePanelHTML` — 상세는 `my-page/skill.md`(일반 유저), `admin/skill.md`(어드민)
